...
const Tangail = () => {
  return (
    <g>
      <path
        d="M332.5,438.1c4.7-1.7,1.9,2.3,5.1,3.7c1.5,0.6,3.4-0.5,5.2-1.8c1.3-0.9,2.4-1.8,3.4-2.2
	...
	C328.8,442.2,329.6,439.1,332.5,438.1z"
      ></path>
      <text transform="matrix(1 0 0 1 317.6667 391.6)">টাঙ্গাইল</text>
    </g>
  );
};

export default Tangail;

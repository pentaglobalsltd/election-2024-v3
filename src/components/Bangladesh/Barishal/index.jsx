...
const Barishal = () => {
    return (
        <g>
            <g>
                <path
                    d="M429.8,623.5c-1.4,2.4-3.7,0.4-5.2,1.7c-1.8,1.6,1.8,2.9,3,4c2,1.8,5.2,8,8.7,6.4c2.6-1.2,0.7-3.2-0.1-4.9
				c-1.2-2.9,0.1-2.6,1.5-4.7c3.3-4.8-0.6-9.1-5.4-5.4c-1.3,1-1.9,2.6-3.2,3.4"
                ></path>
                <path
                    d="M422.7,634.8c0.7-3.6-5.5-6.9-8.3-3.9c-2.8,3,2.2,8.4,1.2,12.2c-1.1,4.2-4.7,5.6-3,10.4
                ...
                ></path>
                <path
                    d="M453.2,649.1c1.7-0.8,2.8,2.2,1.4,3.3c-1.3,0.9-4.7-0.2-6-0.6c-4.3-1.5-7.6-0.1-9.7,4.2
                ...
                ></path>
                <path
                    d="M446.3,630.1c2.1-0.5,3.2,3.8,4.3,5.3c1.3,1.8,4.5,3.1,3.6,6c-1,3.4-3.8-1.8-5.1-3.1
				c-1.3-1.3-1.6-0.7-2.3-2.7c-0.6-1.4-0.6-3-1.3-4.3c0.4-0.2,0.7-0.5,1.1-0.6"
                ></path>
            </g>
            <path
                d="M438.6,603.4c-0.1-0.3-0.1-0.5-0.2-0.8c-1.1,0.2-2.1,0.3-2.8,0c-0.6-0.2-1.3-1.7-1.8-2.1
            ...
            <text transform="matrix(1 0 0 1 368.5106 632.7006)">বরিশাল</text>
        </g>
    );
};

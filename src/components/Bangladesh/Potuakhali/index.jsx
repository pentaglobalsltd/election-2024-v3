...
const Potuakhali = () => {
    return (
        <g>
            <g>
                <path
                    d="M429.5,786.1c-2.2-0.2-6,2.6-8.2,3.6c-3,1.3-6.5,2.7-8.5,5.8c-1.6,2.4-2.6,5.8-3.6,8.5
			...
			c-0.3-1.1-1.2-3.4-2.3-1.6"
                ></path>
                <path
                    d="M441.4,763c-2.2,1.6,1,4.7,1.4,6.6c0.6,2.7-0.1,5.9-1.2,8.2c-1.6,3.4-9.1,9.7-4.9,13.4
			c1.8-0.5,1.7-2.1,2.5-3.5c0.8-1.5,1.7-2.1,2.9-3.3c2.3-2.3,3.7-4.4,4.7-7.4c1.1-3.4,0.9-5.4-0.5-8.6c-0.6-1.4-3.6-8.3-5.5-4.3"
                ></path>
                <path
                    d="M436.1,769c-3.1,0.3-1.1,4.4-1.6,6.3c-0.4,1.3-3.7,5.7,0.3,3.8c1.3-0.6,3.6-4,3.8-5.5
			c0.3-1.9-1.2-5.4-3.5-4.4"
                ></path>
                <path
                    d="M446.8,791c-2.7,0.9-5.2,3.6-7.5,5.2c-3.9,2.7-4,3.9-3.7,7.9c2,0.4,2-1.6,3.3-2.6c1.5-1.3,3.5-1.3,5.1-2.6
			c1.3-1,6.7-7.6,2.5-7.9"
                ></path>
                <path
                    d="M448.8,711.9c-3.1,1.1-0.9,5.9-0.2,8.2c1.4,0.9,1.9,4,2.7,4.4c2.2,1.1,2.2-2.3,1.9-3.5
			c-0.5-2.2-2.1-2.5-2.9-4.2c-0.9-1.7,0.2-3.8-1.7-4.9c-0.5,0-0.3,0.3-0.6,0.6"
                ></path>
                <path d="M452.9,732.5c-1.2,0.7-4.1,7.7-0.6,6.8c0,0,2.5-3.1,2.5-3.2c0.4-2-0.8-3-2.7-3"></path>
                <path d="M453.7,741.3c-2,0.9-3.5,8.7,0.6,5c0.7-0.7,2-2.5,1.8-3.4c-0.3-1.3-2.1-2.3-3.2-1"></path>
                <path d="M449.3,750.4c-5-0.8-1.8,4.9-3.9,6.9c3.1,3.2,8.2-6.9,2.8-6.3"></path>
            </g>
            <path
                d="M427.9,680.5c-1.5,1.3-2.6,0.5-4.3,0.5c-3.5,0-6.7,2.9-7.6,6.1c-0.4,1.6-0.3,3.4-1,4.9c-1.4,3.2-4,3.2-7.2,3.5
		...
		c-1.6-2.6-1.8-6.6-2.7-9.6c-0.9-3.3,0.1-6.9-1.7-9.8c-1.2-1.9-3.1-2.9-5.2-3.3C428.8,679.6,428.5,680.1,427.9,680.5z"
            ></path>
            <text transform="matrix(1 0 0 1 382.6753 721.999)">পটুয়াখালী</text>
        </g>
    );
};

export default Potuakhali;

...
const Madaripur = () => {
  return (
    <g>
      <path
        d="M357.5,545.1c0.4,2.7,1.2,7.2-0.8,9.5c-3.3,3.8-6.1-3-8.3-4.4c-2.5-1.5-3.4,0.5-4.9,1.8
	...
	c-1.4-1.1-3-1.8-4.4-2.6C357,539.3,357.1,542.5,357.5,545.1z"
      ></path>
      <text transform="matrix(1 0 0 1 328 582.3002)">মাদারীপুর</text>
    </g>
  );
};

export default Madaripur;

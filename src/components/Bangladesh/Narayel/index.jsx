...
const Narayel = () => {
  return (
    <g>
      <path
        d="M310.3,612.1c-0.1-1.7-2.2-3.2-3.5-4.4c-2.2-2.1-1.3-1.8-1.7-4.2c-0.5-2.7-4.8-6.4-6.8-8.7
	...
	c1.3,0,2.5-0.3,3-1.3C310.3,613.5,310.4,612.9,310.3,612.1z"
      ></path>
      <text transform="matrix(1 0 0 1 249.8582 591.4)">নড়াইল</text>
    </g>
  );
};

export default Narayel;

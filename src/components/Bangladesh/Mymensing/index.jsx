...
const Mymensing = () => {
	return (
		<g>
			<path
				d="M371.8,245.1c0.3,1.4-0.8,3.8-1.1,5.1c-0.3,1.6-0.7,3.3-0.6,4.9c0.1,1.1,0.6,2.5,1,3.5c0.5,1.1,1.6,1.8,2.1,2.9
	...
	c-3.5,0.2-4-4.6-7.3-5.7c-3.5-1.1-6.5,0.1-10.1-0.3c-0.9-0.1-1.2,0.2-1.1,0.2C370.8,243.4,371.6,244.2,371.8,245.1z"
			...
			<g>
				<g>
					<text transform="matrix(1 0 0 1 368.5103 331.8945)">ময়মনসিংহ</text>
				</g>
			</g>
		</g>
	);

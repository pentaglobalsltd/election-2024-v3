...
const Shatkhira = () => {
    return (
        <g>
            <g>
                <path
                    d="M210.2,786.9c0,4.7-8.5,1.8-6.6,8c1,3.1,6.6,6.6,4.1,10.4c0,0,0.4,0.5,0.4,0.5c0.6-0.2,1.5-0.7,1.8-1.1
        c-0.3-3.6,2.9-1.7,4.4-2.2c2.6-0.9,1.2-3,1.1-5.4c-0.1-2.3,0.4-3.5-1.4-5.5c-0.6-0.7-1.6-1.3-2.3-2.1c-0.7-0.9-0.2-1.9-1.6-2.3"
                ></path>
                <path
                    d="M232.3,803.4c1.1,1.7,3.1,2.5,4,4.3c0.8,1.7,0.7,4.1,1.1,6c0.9,4.2-0.8,8.6,1.1,12.7c0.9,1.8,2.7,3.3,2.9,5.5
        ...
        C230,796.3,230.9,801.2,232.3,803.4z"
                ></path>
                <path
                    d="M242.3,782.8c-1.2,0.2-0.2,5.6-1,7.2c-1.3,2.6-3.5,4.6,0.2,6.8c0.5,2-0.5,7.9,3.3,6.3
        c1.7-0.7,1.2-2.3,1.6-3.6c0.5-1.6,0.8-2.1,1.9-3.6c2.2-3.2,1.1-4.5-0.6-7.7c-1.2-2.3-2.6-5.3-5.9-4.9c-0.1,0.3,0,0.5,0,0.8"
                ></path>
                <path
                    d="M224.7,803.9c-4.2-2.5-3.9,7.5-3,9.6c0.7,1.7,2.3,3.1,3.2,4.7c0.9,1.7,1.1,3.8,2.1,5.3
        ...
        C225.7,805.4,226.3,804.1,224.7,803.9"
                ></path>
                <path
                    d="M215.1,812.7c3.9,3.6,2.1,7,3,11.8c0.9,4.4,6.9,5.3,7.7,9c1.2,5.5-6,0.4-7.4-1.4c-2.8-3.8-2.8-6.9-2.5-11.2
        c0.1-1.3,0.1-2.7-0.3-3.9c-0.6-1.3-2-1.7-1.8-3.3c0.5-0.2,0.2-1.2,0.7-1.1"
                ></path>
            </g>
            <path
                d="M242.2,767.2c-0.5-1.8-0.2-3.4-1.7-4.9c-1.2-1.2-2.8-0.8-3.3-3c-0.5-2.2,0.9-2.6,2.3-4.1
    ...
    z"
            ...
            <text transform="matrix(1 0 0 1 172.1432 690.524)">সাতক্ষীরা</text>
        </g>
    );
};

export default Shatkhira;
